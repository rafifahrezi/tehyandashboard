...
@section('content')
    <div class="container mx-auto px-6 py-8">
        ...
        <form action="{{ route('manajemen.bahan-admin.store') }}" method="POST"
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input name="nama_bahan" value="{{ old('nama_bahan') }}" placeholder="Masukkan nama bahan" required
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input name="stok_sekarang" type="number" value="{{ old('stok_sekarang', 0) }}" step="0.01" placeholder="0"
                                required min="0"
                                class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                        </div>
                        <div>
                            ...
                            <input name="min_stok" type="number" value="{{ old('min_stok', 0) }}" step="0.01"
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input name="harga" type="number" value="{{ old('harga', 0) }}" step="0.01"
                    ...
                    <div>
                        ...
                        <input name="supplier" value="{{ old('supplier') }}" placeholder="Masukkan nama Supplier/Toko"
                            required
                            class="w-full rounded-lg border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 items-start">
                        <div>
                            ...
                            <select name="satuan" required
                                class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 shadow-sm">
                                <option value="" disabled {{ old('satuan') ? '' : 'selected' }}>
                                    -- Pilih Satuan --
                                </option>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <label class="inline-flex items-center">
                                <input type="radio" name="status" value="nonaktif"
                                    {{ old('status') == 'nonaktif' ? 'checked' : '' }} class="form-radio text-red-600">

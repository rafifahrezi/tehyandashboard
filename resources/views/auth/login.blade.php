<x-guest-layout>
    <div class="min-h-screen bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-700 
            ...
            <div class="bg-white rounded-3xl p-8 shadow-2xl w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <svg class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-data="{ showPassword: false }">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <svg x-show="showPassword" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display: none;">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-emerald-600 font-semibold hover:text-emerald-700 transition-colors">
                                {{ __('Lupa password?') }}
                            </a>
                        @endif
                    </div>
                    ...
                    {{-- Button --}}
                    <div class="mt-6">
                        <x-primary-button class="w-full bg-emerald-600 hover:bg-emerald-700 focus:bg-emerald-700 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                            {{ __('Masuk') }}
                        </x-primary-button>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const alerts = document.querySelectorAll('[class*="bg-red-50"], [class*="bg-green-50"], [class*="bg-blue-50"]');
